...
def create_comparison_heatmap(swarm_res_dir, rows_per_node, metric='auc'):
    ...
    if metric == 'auc':
        ...
        difference = central_values - swarm_values
        diff_label = 'Central - Swarm\n(Positive = Swarm better)'

    # --- 🎨 Colormap a scaglioni (discreta) ----
    bounds = [-1, -0.05, -0.01, 0.01, 0.05, 1]  # 5 scaglioni
    ...
    # Save plot
    filename = f'{out_dir}/comparison_heatmap_{metric}_{rows_per_node}rows_discrete.png'

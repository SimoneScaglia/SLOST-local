...
directories = [
    "../results/heatmap_experiments/5_0_lr0.0010_bs32",
    "../results/heatmap_experiments/5_0_lr0.0010_bs64",
    "../results/heatmap_experiments/5_0_lr0.0010_bs128",
    "../results/heatmap_experiments/5_0_lr0.0025_bs32",
    "../results/heatmap_experiments/5_0_lr0.0025_bs64",
    "../results/heatmap_experiments/5_0_lr0.0025_bs128",
    "../results/heatmap_experiments/5_0_lr0.0050_bs32",
    "../results/heatmap_experiments/5_0_lr0.0050_bs64",
    "../results/heatmap_experiments/5_0_lr0.0050_bs128",
    "../results/heatmap_experiments/5_0_lr0.0100_bs32",
    "../results/heatmap_experiments/5_0_lr0.0100_bs64",
    "../results/heatmap_experiments/5_0_lr0.0100_bs128",
    "../results/heatmap_experiments/5_0_lr0.0250_bs32",
    "../results/heatmap_experiments/5_0_lr0.0250_bs64",
    "../results/heatmap_experiments/5_0_lr0.0250_bs128",
    "../results/heatmap_experiments/5_0_lr0.0500_bs32",
    "../results/heatmap_experiments/5_0_lr0.0500_bs64",
    "../results/heatmap_experiments/5_0_lr0.0500_bs128",
    "../results/heatmap_experiments/5_0_lr0.0750_bs32",
    "../results/heatmap_experiments/5_0_lr0.0750_bs64",
    "../results/heatmap_experiments/5_0_lr0.0750_bs128"
]
...
for directory in directories:
    csv_path = os.path.join(directory, 'swarm_results.csv')
...
out_dir = 'plots_results/plot_heatmap_swarm'
...
sns.heatmap(auc_matrix, 
            ...
            cmap="RdYlGn",
            cbar_kws={'label': 'AUC'})
plt.title('AUC Heatmap: 5-Node SL Network (1000 rows/node)')
plt.xlabel('Learning Rate')
plt.ylabel('Batch Size')
plt.tight_layout()
plt.savefig('plots_results/plot_heatmap_swarm/auc_heatmap.png', dpi=300, bbox_inches='tight')
...
sns.heatmap(loss_matrix, 
            ...
            cbar_kws={'label': 'Loss'})
plt.title('Loss Heatmap: 5-Node SL Network (1000 rows/node)')
plt.xlabel('Learning Rate')
plt.ylabel('Batch Size')
plt.tight_layout()
plt.savefig('plots_results/plot_heatmap_swarm/loss_heatmap.png', dpi=300, bbox_inches='tight')
